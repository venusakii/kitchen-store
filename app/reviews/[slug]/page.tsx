...
const products = [
  ...
  },
  {
    ...
    fullDescription:
      "The CAROTE Nonstick Cookware Set features granite-infused coating for superior non-stick performance and healthy cooking. This induction-compatible collection includes saucepans, frying pans, and more, all designed for even heating and easy release with minimal oil.",
    features: [
      "Granite non-stick coating",
      "Induction-ready base",
      "Oven-safe up to 450°F",
      "Cool-touch bakelite handles",
      "10-piece set for complete kitchen needs",
    ],
    pros: [
    ...
    cons: ["Coating may wear with metal utensils", "Handles can loosen over time"],
    verdict: {
      quality: 4,
      value: 5,
      performance: 4,
      overall: 8.9,
      summary: "A solid nonstick set for everyday healthy meals.",
    },
  },
]
